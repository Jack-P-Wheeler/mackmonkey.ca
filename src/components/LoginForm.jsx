...
const LoginForm = () => {
    ...
    return (
        <form className="border p-4 rounded-md shadow-lg grid grid-cols-3 grid-rows-4" onSubmit={(ev) => loginAuthWithPassword(ev, formData.user, formData.password)}>
            ...
            <button className="border-blue-500 border px-2 py-1 rounded-md bg-blue-400 shadow-inner font-bold text-white col-start-2 row-start-4 mt-4 hover:underline">Log In</button>
        </form>
    )
}
