...
const CreateAccountForm = () => {
    ...
    const initialFormData = {user: "", password: "", email: ""}
    ...
    return (
        <form className="border p-4 rounded-md shadow-lg grid grid-cols-3 grid-rows-4" onSubmit={(ev) => createAccount(ev, formData.user, formData.password, formData.email)}>
